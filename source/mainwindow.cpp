    ...
    : QMainWindow(parent)
{
    ...
    undoView->setWindowTitle(QString("Command List"));
...
void MainWindow::createActions()
{
    ...
    aboutAct->setStatusTip(tr("Show the application's About dialogue"));
    connect(aboutAct, SIGNAL(triggered()), this, SLOT(about()));

    aboutQtAct = new QAction(tr("About &Qt"), this);
    aboutQtAct->setStatusTip(tr("Show the Qt library's About dialogue"));
...
DrawView *MainWindow::createMdiChild()
{
    ...
    QRectF rc = QRectF(0 , 0 , 1920, 1080);
